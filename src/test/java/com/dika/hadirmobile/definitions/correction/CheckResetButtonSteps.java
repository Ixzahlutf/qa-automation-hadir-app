...
public class CheckResetButtonSteps extends AuthProviders{
    ...
    public void step05() throws InterruptedException{
        ...
        Thread.sleep(1000);
        Assert.assertTrue(koreksiAbsenPage().isJamMasukFieldEmpty());
        Assert.assertTrue(koreksiAbsenPage().isJamKeluarFieldEmpty());
        Assert.assertTrue(koreksiAbsenPage().isPilihTipeAbsenNotDisplayed(), "Tipe absen masih muncul di layar");
    }
