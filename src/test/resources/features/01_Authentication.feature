Feature: Authentication Feature
  ...
  Scenario: SignIn dengan email tanpa '@'
    Given pengguna masuk ke halaman login untuk menguji email tanpa '@'.
    When pengguna memasukkan username "hadirsqa1gmail.com" dan password "SQA@Hadir12345".
    And pengguna menekan tombol masuk setelah mengisi data.
    Then pengguna melihat pesan kesalahan "Please include an '@' in the email address. 'hadirsqa1gmail.com' is missing an '@'.".
  ...
  Scenario Outline: Register using Invalid Data in Aplikasi Hadir
    ...
    Scenario: Register dengan email tanpa '@'
    Given pengguna masuk ke halaman register untuk menguji email tanpa '@'.
    When pengguna masukkan email "hadirsqa1gmail.com" dan data lainnya.
    And pengguna tekan tombol masuk setelah mengisi data.
    Then pengguna lihat pesan kesalahan "Please include an '@' in the email address. 'hadirsqa1gmail.com' is missing an '@'.".
  ...
  Scenario: Navigation to halaman Lupa password Page in Aplikasi Hadir
